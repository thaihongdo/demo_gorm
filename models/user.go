...
func (obj *User) GetTotal(data map[string]interface{}) (int, error) {
	var count int
...
func (obj *User) MigrateData() {
	if total, _ := obj.GetTotal(map[string]interface{}{}); total == 0 {
		passHash, _ := utils.HashPassword("123456")

		obj = &User{Email: "admin@gmail.com", Password: passHash, FullName: "Admin"}
		_, _ = obj.Add()
	}
